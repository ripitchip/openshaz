...
class SimilarityEngine:
    ...
    def find_similar(
        ...
        for idx in top_indices:
            ...
            # Add metadata if DataFrame is available
    ...
    def evaluate(self, test_df: pd.DataFrame, top_k: int = 5) -> dict:
        ...
        for idx, row in test_df.iterrows():
            # Extract genre from filename (e.g., "blues.00001" -> "blues")
            ...
            # Check if any of the top k have the same genre
